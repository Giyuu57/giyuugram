-- ============================================================
-- GIYUUGRAM — COMPLETE SCHEMA (run this entire file once, in order,
...
-- ============================================================
-- 6. COMMENTS (supports replies via parent_id)
-- ============================================================
...
-- ============================================================
-- 8. STORIES (auto-expire after 24h — enforced via query filter + RLS)
-- ============================================================
...
-- Keep conversations.last_message_at fresh whenever a new message arrives
-- (used to sort the chat list by most recent activity).
...
-- CHAT-MEDIA bucket policies (private — only conversation participants,
-- enforced at the app layer by only ever generating signed URLs for
-- participants; bucket itself is private/non-public)
create policy "Users can upload own chat media"
  on storage.objects for insert
  with check (bucket_id = 'chat-media' and (storage.foldername(name))[1] = auth.uid()::text);
create policy "Users can read own uploaded chat media"
  on storage.objects for select
...
-- 2. Go to Project Settings → API → copy your Project URL + anon key
--    into lib/core/services/supabase_client.dart.
-- ============================================================
